...
TOOL.Name = "Self Material"
if (CLIENT) then
	language.Add("tool.selfmaterial.name", TOOL.Name) 
	language.Add("tool.selfmaterial.desc", "Set material to yourself")
	language.Add("tool.selfmaterial.left", "Set material to yourself.")
	language.Add("tool.selfmaterial.reload", "Reset material.")
end
